...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" rel="stylesheet">
  ...
  <link href="../css/profile_details_post.css" rel="stylesheet">
...
.modal {
    ...
    z-index: 1050; /* Adjust the z-index */
    left: 0;
    top: 0;
    width: 100%;
    height: 100%;
...
<!-- Modal for Help --><div class="modal fade" id="helpModal" tabindex="-1" aria-labelledby="helpModalLabel" aria-hidden="true" style="z-index: 1051;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="container-fluid mt-4" style="margin-left: 20px;">
  <div class="profile-details" style="border: 2px solid; padding: 20px; border-image: linear-gradient(115deg, #3cc5d7, #47d794, #3498db) 1;">
    ...
    <div class="details" style="margin-bottom: 5px;">
      <p>Pet I Like: <?php echo $pet_type; ?></p>
    ...
    <a href="edit_profile.php">
      <button type="button" class="edit-button" style="background: linear-gradient(115deg, #3cc5d7, #47d794, #3498db); color: #fff; border: none; padding: 10px 20px; transition: background 0.3s ease;">
...
<style>
  ...
  <!-- Post Container -->
  <div class="post-container" style="margin-right: 30px; margin-left: 10px;">
    <form action="../process.php" method="POST" enctype="multipart/form-data">
      ...
      <button type="submit" class="btn" name="post_profile">Post</button>
    </form>

    <div class="post-profile">
<?php
$getpost = mysqli_query($conn, "SELECT * FROM post WHERE posted_by='$fullname'");
...
?>
    <div class="post-home" data-post-id="<?php echo $row1['id']; ?>">
            ...
            <div class="posted-by-container">
                ...
                <div class="ellipsis-container" id="ellipsisDropdown_<?php echo $row1['id']; ?>" onclick="toggleDropdown(<?php echo $row1['id']; ?>)">
                    <div class="dropdown-menu" id="dropdownMenu_<?php echo $row1['id']; ?>" style="display: none;">
                        <a href="#" onclick="editPost(<?php echo $row1['id']; ?>, '<?php echo $row1['post_desc']; ?>')">Edit</a>
        ...
        <?php if (!empty($row1['post_media'])) { ?>
            <img src="../post/<?php echo $row1['post_media']; ?>" class="post-media">
        <?php } ?>
...
<div id="editFoundModal" class="modal">
    <div class="modal-content">
        ...
        <form action="../process.php?id=<?php echo isset($id) ? $id : ''; ?>" id="editFoundForm" method="POST">
            ...
            <textarea name="post_desc" id="edit_found_desc" style="width: 100%; border: 1px solid; border-image: linear-gradient(115deg, #3cc5d7, #47d794, #3498db) 1;"></textarea><br>
            <!-- Button below textarea -->
            <button type="submit" class="update-button" name="update_post">Update</button>
        </form>
    </div>
</div>
...
<script>
    ...
    function editPost(postId, postDesc) {
        ...
        editDescInput.value = postDesc; // Populate the textarea with the post description
        editIdInput.value = postId; // Populate the hidden input with the post ID
