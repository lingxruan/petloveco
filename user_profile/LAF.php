...
<div class="container mt-4" id="postFormContainer">
    <h4 style="text-align: center;"> Report Lost Pet</h4>
  ...
  <form action="../process.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <textarea class="form-control" rows="3" placeholder="Please describe your lost pet..." name="lost_desc"></textarea>
    </div>
    <div class="form-group">
      <label for="mediaInput">Upload Media:</label>
      <input type="file" class="form-control-file" name="lost_media">
    </div>
    <input type="hidden" name="posted_by" value="<?php echo $fullname;?>">
    <button type="submit" class="btn" name="lost">Post</button>
  </form>
</div>

<div class="post-profile">
<?php
$getpost = mysqli_query($conn, "SELECT * FROM lost WHERE posted_by='$fullname'");
...
?>
    <div class="post-home" data-post-id="<?php echo $row1['id']; ?>">
            ...
            <div class="posted-by-container">
                ...
                <div class="ellipsis-container" id="ellipsisDropdown_<?php echo $row1['id']; ?>" onclick="toggleDropdown(<?php echo $row1['id']; ?>)">
                    <div class="dropdown-menu" id="dropdownMenu_<?php echo $row1['id']; ?>" style="display: none;">
                        <a href="#" onclick="editPost(<?php echo $row1['id']; ?>, '<?php echo $row1['lost_desc']; ?>')">Edit</a>
        ...
        <p class="post-lost_desc"><?php echo $row1['lost_desc']; ?></p>
        <?php if (!empty($row1['lost_media'])) { ?>
            <img src="../lost/<?php echo $row1['lost_media']; ?>" class="post-media">
        <?php } ?>
...
<div id="editFoundModal" class="modal">
    <div class="modal-content">
        ...
        <form action="../process.php?id=<?php echo isset($id) ? $id : ''; ?>" id="editFoundForm" method="POST">
            ...
            <textarea name="lost_desc" id="edit_found_desc" style="width: 100%; border: 1px solid; border-image: linear-gradient(115deg, #3cc5d7, #47d794, #3498db) 1;"></textarea><br>
            <!-- Button below textarea -->
            <button type="submit" class="update-button" name="lost">Update</button>
        </form>
    </div>
</div>
